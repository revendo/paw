...
}, fg = /* @__PURE__ */ Ce(zh, [["__scopeId", "data-v-ee12da86"]]), Gh = { class: "relative w-fit" }, jh = { class: "flex flex-col" }, Kh = ["onClick"], Xh = {
  __name: "DropDown",
  props: {
    items: {
      type: Array,
...
const hg = /* @__PURE__ */ Ce(Rm, [["render", Ym]]);
...
}), mg = /* @__PURE__ */ Ce(Um, [["__scopeId", "data-v-5cd34538"]]), Hm = 8, Bm = 5, zm = {
  name: "PawTable",
  emits: [
    "filtered",
    "selected",
            ...
            F("td", {
              ...
              s.hasStickyDetails() || !n.informal ? (g(), x("div", {
                ...
                (!n.informal && !n.loading || n.informal) && !n.actionDropdownItems.length ? (g(), $(f, {
                  ...
                  _: 2
                }, 1032, ["icon", "outlined", "onClicked", "class"])) : (g(), x("div", $m, [
                  ce(i, {
...
const gg = /* @__PURE__ */ Ce(zm, [["render", ug]]);
export {
  Ur as PawButton,
  rs as PawCheckbox,
  Qi as PawChip,
