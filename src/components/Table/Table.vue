<template>
    <div
                ...
                <div
                    ...
                    <div class="flex flex-row transition-all">
                        <PawButton
                            ...
                            title="Search"
                            icon="search"
                            @clicked="openSearchbar()"></PawButton>
                        ...
                        <PawDropdown
                            ...
                            @selected="
                                (v) =>
                                    this.$emit('searchDropdownItemClicked', v)
                            " />
                        <PawCrazyInput
                            ref="searchbar"
                            :value="searchValue"
                    ...
                    <PawButton
                        ...
                        @clicked="
                            this.$emit('buttonClicked', button.identifier)
                        "
                        :disabled="loading"
                ...
                <div
                    ...
                    <div class="flex flex-row w-full">
                        <PawButton
                            ...
                            title="Search"
                            icon="search"
                            @clicked="openSearchbar('mobile')"></PawButton>
                    ...
                    <tr
                        ...
                        <th
                            ...
                            :class="[
                                ...
                                heading.align === 'left' || !heading.align
                                    ? 'text-left'
                                    : '',
                        ...
                        <th
                            ...
                            <div
                                ...
                                class="absolute top-0 bottom-0 left-0 -right-4 -z-10 transition"></div>
                        </th>
                    </tr>
                </thead>
                ...
                <tbody>
                    <tr
                        ...
                        :class="{
                            ...
                            'h-8 hover:bg-gray-100 dark:hover:bg-gray-800':
                                !informal,
                        ...
                        <td
                            ...
                            <PawLazyField
                                ...
                                :link="
                                    heading.action === 'link'
                                        ? item[heading.name].link
                                        : null
                                "
                                :insecure="
                                    heading.action === 'link'
                                        ? item[heading.name].insecure
                                        : null
                                "
                                ...
                                :valueIconPosition="
                                    heading.format == 'icon'
                                        ? item[heading.name].iconPosition
                                        : ''
                                "
                                :valueColorClass="
                                    heading.format == 'icon'
                                        ? item[heading.name].valueColor
                                        : ''
                                ">
                                {{
                                    cellValue(
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <template v-if="!informal">
                                        <div
                                            class="w-8 h-2 bg-action-300 dark:bg-action-600 rounded-md"></div>
                                        <PawIcon
                                            size="sm"
                                ...
                                <div
                                    v-if="informal"
                                    class="border-r border-t border-b border-gray-200 dark:border-gray-700 rounded-r-lg absolute top-2 right-4 bottom-2 -left-12 h-12 z-10 group-hover:shadow-card dark:group-hover:shadow-card-dark transition-all"></div>

                                <!-- cap background small -->
                                <div
                                    v-if="informal"
                                    :class="`${bgLight} dark:${bgDark} absolute top-2 bottom-2 left-0 right-0 z-0 transition`"></div>
        ...
        <div
            ...
            <div
                :class="{
                    'italic text-danger-500 dark:text-danger-400 transition':
                        error,
                }"
    ...
    export default {
                ...
                messages: {
                    en: {
                        table: {
                            ...
                            missingAttribute:
                                "{attr} attribute missing in {obj} prop",
                            next: "Next",
                            previous: "Previous",
                    ...
                    de: {
                        table: {
                            ...
                            missingAttribute:
                                "Attribut {attr} fehlt in {obj} prop",
                            next: "Weiter",
                            previous: "Zurück",
        ...
        computed: {
            headings() {
                ...
                return [...this.data.headings].sort(
            ...
            meta() {
                ...
                meta.pagination =
                    (this.data.meta.pagination < 1
                        ? 1
                        : this.data.meta.pagination) || 10;
                // Number of pages (default: 1)
                meta.totalPages =
                    Math.ceil(meta.totalRecords / meta.pagination) || 1;
                ...
                meta.lastItem =
                    Math.min(
                        meta.firstItem + meta.pagination - 1,
                        meta.totalRecords
                    ) || this.items.length;
                //console.log(meta);
        ...
        methods: {
            ...
            selectRadio(eventValue, id) {
                ...
                const previouslySelectedItem = this.items.find(
                    (item) => item.selected
                );
                ...
                const newItemToSelect = this.items.find(
                    (item) => item.id === id
                );
