...
export default {
  ...
  argTypes: {
    ...
    multiline: {
      ...
      description:
        "Breaks crazy input's content in multiple lines by text overflow?<br><b>Shortcut:</b> `<PawCrazyInput multiline></PawCrazyInput>`",
      table: {
        category: "Text field",
      },
    },
    select: {
      control: { type: "boolean" },
      description:
        "Results are shown in a single option list.<br><b>Shortcut:</b> `<PawCrazyInput select></PawCrazyInput>`",
      table: {
        category: "Text field",
      },
    },
    multiselect: {
      control: { type: "boolean" },
      description:
        "Results are shown in a multiple selection list.<br><b>Shortcut:</b> `<PawCrazyInput multiselect></PawCrazyInput>`",
      table: {
        category: "Text field",
      },
    },
    ...
    item: {
      control: { type: "object" },
      description:
        '<span className="material-icons align-bottom mr-1">error</span> <b>Internal component property</b>.<br>JSON object containing one specific search result.',
      table: {
        category: "Search results (dropdown)",
      },
    },
    isOpen: {
      control: { type: "boolean" },
      description:
        '<span className="material-icons align-bottom mr-1">error</span> <b>Internal component property</b>.<br>Is dropdown currently opened?',
      table: {
        category: "Search results (dropdown)",
      },
    },
    ...
    dropdownWrap: {
      control: { type: "boolean" },
      description:
        "Is the crazy input wrapped in a container which includes the dropdown height?<br><b>Shortcut:</b> `<PawCrazyInput dropdownWrap></PawCrazyInput>`",
      table: {
        category: "Search results (dropdown)",
      },
    },
    ...
    loading: {
      control: { type: "boolean" },
      description:
        "Is crazy input in loading mode?<br><b>Shortcut:</b> `<PawCrazyInput loading></PawCrazyInput>`",
      table: {
        category: "State",
      },
    },
    readonly: {
      control: { type: "boolean" },
      description:
        "Can the crazy input only be read (no edition possible)?<br><b>Shortcut:</b> `<PawCrazyInput readonly></PawCrazyInput>`",
      table: {
        category: "State",
      },
    },
    disabled: {
      control: { type: "boolean" },
      description:
        '<span className="material-icons-outlined align-bottom">integration_instructions</span> <b>Not yet implemented</b>.<br>Is the crazy input disabled?<br><b>Shortcut:</b> `<PawCrazyInput disabled></PawCrazyInput>`',
      table: {
        category: "State",
      },
    },
    ...
    contextIconOutlined: {
      control: { type: "boolean" },
      description:
        "Is context icon displayed in outline theme?<br><b>Shortcut:</b> `<PawCrazyInput contextIconOutlined></PawCrazyInput>`",
      table: {
        category: "Context elements (left)",
      },
    },
    ...
    contextChecked: {
      control: { type: "boolean" },
      description:
        "Is custom control checked?<br><b>Shortcut:</b> `<PawCrazyInput context-checked></PawCrazyInput>`",
      table: {
        category: "Context elements (left)",
      },
    },
    contextDisabled: {
      control: { type: "boolean" },
      description:
        "Is custom control disabled?<br><b>Shortcut:</b> `<PawCrazyInput context-disabled></PawCrazyInput>`",
      table: {
        category: "Context elements (left)",
      },
    },
    ...
    extraIconOutlined: {
      control: { type: "boolean" },
      description:
        "Is extra icon displayed in outline theme?<br><b>Shortcut:</b> `<PawCrazyInput extraIconOutlined></PawCrazyInput>`",
      table: {
        category: "Extra elements (right)",
      },
    },
    ...
    cancelled: {
      description:
        "Fired either when search loading is cancelled, when dropdown is closed or when all input text is deleted.",
    },
    optionFocused: {
      description:
        '<span className="material-icons align-bottom mr-1">error</span>  <b>Internal component event</b>.<br>Triggered when dropdown option is focused.',
    },
    optionSelected: {
      description:
        '<span className="material-icons align-bottom mr-1">error</span> <b>Internal component event</b>.<br>Triggered when dropdown option is selected.',
    },
    optionMoved: {
      description:
        '<span className="material-icons align-bottom mr-1">error</span> <b>Internal component event</b>.<br>Triggered when focus is moved across dropdown options with arrow keys.',
    },
    optionTyped: {
      description:
        '<span className="material-icons align-bottom mr-1">error</span> <b>Internal component event</b>.<br>Triggered when text is typed on dropdown\'s option.',
    },
    dropdownClosed: {
      description:
        '<span className="material-icons align-bottom mr-1">error</span> <b>Internal component event</b>.<br>Triggered when escape key is pressed within the dropdown.',
    },
    keyDownEnter: {
      description: "Fired on enter keydown.",
    },
  },
};
...
SelectEmail.parameters = {
  docs: {
    storyDescription:
      '<span class="material-icons align-bottom" style="margin-right: 4px; font-size: 24px; font-family: \'Material Icons\';">error</span> <b>How to use</b>: After typing something in, close and open dropdown again with right icon in order to see the options.',
    source: {
      code: `
